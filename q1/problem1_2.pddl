;; ============================================================
;; D5-V1 Q1 -- Problem 2: COST-OPTIMIZED MONITORING
;;
;; Same layout and goal, but now the planner MINIMIZES total
;; cost. Since cost increases only on move, this asks for the
;; plan with the FEWEST moves -- an efficient monitoring tour.
;;
;; Run with an optimal planner (e.g. ENHSP -planner opt-hrmax)
;; so the metric is respected.
;;
...
(define (problem crop-mon-q1-p2)
  ...
  ;; MINIMIZE total cost -- fewest moves (efficient tour).
